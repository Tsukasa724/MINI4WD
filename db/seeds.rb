...
Shop.create!(shop_name: '株式会社タミヤ', address: '静岡市駿河区恩田原3-7' , business_hours: '8:00 ~ 17:00' , regular_holiday: '木曜日' , shop_gazou: '/assets/店舗画像/店舗１-ce084d3f84ac4332c10b7040ca1910a6e4ca98f1ab2e34be47f825251a644d66.jpeg', course_layout: '/assets/コースレイアウト/コース１-466c1fe73d1d65e17be8afebc3948c1fb75f61c26d69a006c1bd2efa1d2e7e46.jpeg')
Shop.create!(shop_name: '小鹿第一工場', address: '静岡市駿河区小鹿1丁目63-20' , business_hours: '9:00 ~ 18:00' , regular_holiday: '水曜日' , shop_gazou: '/assets/店舗画像/店舗２-64c0219dae2664b969134bd6f1938aedb041d6dc4b59c76e0eab2ebe94562cac.jpeg', course_layout: '/assets/コースレイアウト/コース２-17167937954814b64327db44173e741801a7e827fab327b7181aa34cee769350.jpeg')
Shop.create!(shop_name: '池田工場', address: '静岡市駿河区池田144-1' , business_hours: '8:30 ~ 17:00' , regular_holiday: '月曜日' , shop_gazou: '/assets/店舗画像/店舗３-c826ba6da422c66cd4b910e203af44945a6e70b689d6f31624018bdd10f6cf1f.jpeg', course_layout: '/assets/コースレイアウト/コース３-fa30c35c029547e5aecb876698075d104c30f46b891818b486cdeb8b8836dbae.png')
Shop.create!(shop_name: '第二物流センター', address: '静岡市駿河区小鹿915' , business_hours: '8:45 ~ 19:00' , regular_holiday: '土曜日' , shop_gazou: '/assets/店舗画像/店舗４-bb230920c916e2270bfb6775d7748c77e548e84c91204165d4d19910a4e36c70.jpeg', course_layout: '/assets/コースレイアウト/コース４-15529f8f05c08525cd72a93d7f4be166ed43f8ce08973e21f393953648687348.jpeg')
...
Part.create!(shaft_name: 'ノーマルシャフト')
Part.create!(shaft_name: '中空シャフト')
Part.create!(shaft_name: '強化シャフト')
Part.create!(propeller_name: 'ノーマルプロペラシャフト')
Part.create!(propeller_name: '中空プロペラシャフト')
Part.create!(gikuuke_name: '低摩擦プラリング')
Part.create!(gikuuke_name: '丸穴ボールベアリング')
Part.create!(gikuuke_name: '六角穴ボールベアリング')
Part.create!(terminal_name: 'ノーマルターミナル')
Part.create!(terminal_name: 'ゴールドターミナル')
Part.create!(tire_name: 'レスポンスポンジタイヤ')
Part.create!(tire_name: '中空スポンジタイヤ')
Part.create!(tire_name: 'ソフトスリックタイヤ')
Part.create!(tire_name: 'ハードスリックタイヤ')
Part.create!(tire_name: 'バレルタイヤ')
Part.create!(tire_name: 'オフセットトレッドタイヤ')
Part.create!(tire_name: 'ローハイトタイヤ')
Part.create!(wheel_name: '小径ホイール')
Part.create!(wheel_name: '大軽ホイール')
Part.create!(wheel_name: 'スポークホイール')
Part.create!(wheel_name: 'Yスポークホイール')
Part.create!(wheel_name: '5本スポークタイヤ')
Part.create!(wheel_name: 'ナローワンウェイホイール')
Part.create!(wheel_name: '小径カーボンホイール')
Part.create!(wheel_name: '大軽カーボンホイール')
Part.create!(gear_name: 'ハイスピードカウンターギヤー')
Part.create!(gear_name: '軽量超速ギヤー')
Part.create!(roller_name: '17mmアルミベアリングローラー')
Part.create!(roller_name: '19mmアルミベアリングローラー')
Part.create!(roller_name: 'プラリング付きベアリングローラー')
Part.create!(roller_name: '17mmプラリング付きベアリングローラー')
Part.create!(roller_name: '19mmプラリング付きベアリングローラー')
Part.create!(roller_name: '9mmボールベアリングローラー')
Part.create!(roller_name: '11mmボールベアリングローラー')
Part.create!(roller_name: '低摩擦プラリングローラー')
Part.create!(roller_name: '2段低摩擦プラローラー(13-13mm)')
Part.create!(roller_name: '2段アルミローラー(13-12mm)')
Part.create!(roller_name: '2段アルミローラー(9-8mm)')
Part.create!(roller_name: 'ゴムリング付き２段アルミローラー(13-12mm)')
Part.create!(roller_name: '13mmオールアルミベアリングローラー')
